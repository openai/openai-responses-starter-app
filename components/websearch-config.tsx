...
export default function WebSearchSettings() {
  ...
  // Określ, czy pokazać wybór rozmiaru kontekstu wyszukiwania (tylko dla OpenAI)
  const show_context_size_selector = currentProvider === "openai";
  ...
  return (
    <div>
      ...
      <div className="mt-3 space-y-3 text-zinc-400">
        ...
        {/* Selektor rozmiaru kontekstu wyszukiwania - tylko dla OpenAI */}
